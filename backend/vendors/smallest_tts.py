...
class SmallestTTSService(InterruptibleTTSService):
    ...
    async def _connect_websocket(self):
        try:
            ...
            self._websocket = await websockets_connect(
    ...
    async def run_tts(self, text: str, *args, **kwargs) -> AsyncGenerator[Frame, None]:
        ...
        Args:
            ...
            *args: Additional positional arguments (for decorator compatibility).
            **kwargs: Additional keyword arguments (for decorator compatibility).
