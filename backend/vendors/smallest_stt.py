...
class SmallestSTTService(STTService):
    ...
    def __init__(
        ...
        *,
        api_key: str,
        url: Optional[str] = "wss://waves-api.smallest.ai/api/v1/lightning/get_text",
        ...
        **kwargs,
        ...
        self._url = url
        self._params = params or self.SmallestInputParams()
        self._websocket = None
        self._receive_task = None
        self._settings = {**self._params.model_dump()}
        self._ping_interval = kwargs.get("ping_interval")
        self._ping_timeout = kwargs.get("ping_timeout")
                        ...
                        if event_type == EventType.TRANSCRIPTION.value:
                            ...
                            if len(transcription_response.text) > 0:
                                ...
                                if transcription_response.isFinal:
                                    logger.info(f"{self.name} Final transcription: {transcription_response.text}")
...
class SmallestSTTHTTPService(SegmentedSTTService):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._url = "https://waves-api.smallest.ai/api/v1/pulse/get_text"
        self._headers = {
            "Authorization": f"Bearer {self._api_key}"
        }
        self._payload = {
